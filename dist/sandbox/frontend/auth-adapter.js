...
export function useAuth() {
    ...
    const coreAuthModule = typeof window !== 'undefined' ? window.__FORMARA_CORE_AUTH__ : null;
        ...
        try {
            ...
            const result = {
                user: coreAuth.user ? {
                    ...
                    workspaceId: coreAuth.user.workspaceId || 1,
...
export function authHeaders(token) {
    ...
    try {
        ...
        const coreAuthHeaders = typeof window !== 'undefined' ? window.__FORMARA_AUTH_HEADERS__ : null;
