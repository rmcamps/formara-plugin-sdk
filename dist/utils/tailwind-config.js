 ...
 */
export function getPluginTailwindContent(pluginDir) {
    // Resolver ruta al SDK instalado
    const sdkPath = path.resolve(pluginDir, 'node_modules', '@formara', 'plugin-sdk');
 ...
 */
export function getPluginTailwindSafelist() {
