 ...
 */
export const MaskedInput = forwardRef(({ value = '', onChange, mask, placeholder, ...props }, ref) => {
    ...
    return (_jsx(Input, { ref: inputRef, value: displayValue, onChange: handleChange, onBlur: handleBlur, placeholder: placeholder, ...props }));
});
