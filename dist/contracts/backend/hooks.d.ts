 ...
 */
export type HookEvent = 'file.uploaded' | 'file.processing' | 'file.processed' | 'file.validated' | 'file.updated' | 'file.deleted' | 'document.generated' | 'document.sent' | 'document.signed' | 'form.created' | 'form.updated' | 'form.deleted' | 'form.record.created' | 'form.record.updated' | 'form.record.deleted' | 'form.record.validated' | 'workspace.created' | 'workspace.member.added' | 'user.registered' | 'user.login' | 'system.startup' | 'system.shutdown';
/**
 ...
 */
export type HookEventData = FileEventData | DocumentEventData | FormRecordEventData | FormEventData | any;
/**
