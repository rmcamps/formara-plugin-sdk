 ...
 * ```
 */
export function processMockups(mockupModules: Record<string, { default: any }>): Record<string, { label: string; data: any }> {
 ...
 */
export function loadMockups(): Record<string, { label: string; data: any }> {
 ...
 */
export function loadMockupsFromPattern(pattern: './src/mockups/*.json'): Record<string, { label: string; data: any }>;
export function loadMockupsFromPattern(pattern: '../mockups/*.json'): Record<string, { label: string; data: any }>;
export function loadMockupsFromPattern(pattern: './mockups/*.json'): Record<string, { label: string; data: any }>;
export function loadMockupsFromPattern(pattern: string): Record<string, { label: string; data: any }> {
