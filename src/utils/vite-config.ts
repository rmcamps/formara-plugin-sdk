 ...
 */
export function getPluginViteConfig(pluginDir: string): Partial<UserConfig> {
 ...
 */
export function createPluginViteConfig(pluginDir: string, customConfig: Partial<UserConfig> = {}): UserConfig {
